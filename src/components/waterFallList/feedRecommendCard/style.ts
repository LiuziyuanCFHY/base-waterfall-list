...
export default StyleSheet.create({
    ...
    titleInfo: {
        color: '#222',
        fontSize: TITLE_FONT_SIZE, // 注意TITLE_LINE_HEIGHT随TITLE_FONT_SIZE变化需看下是否需要更改
    ...
    discountPrice: {
        fontSize: MAX_PRICE_FONT_SIZE, // 注意MAX_PRICE_LINE_HEIGHT随MAX_PRICE_FONT_SIZE变化需看下是否需要更改
    ...
    poiTxt: {
        fontSize: MAX_POI_FONT_SIZE, // 注意MAX_POIE随MAX_POI变化需看下是否需要更改
        lineHeight: MAX_POI,
        color: '#666',
    },
    poiName: {
