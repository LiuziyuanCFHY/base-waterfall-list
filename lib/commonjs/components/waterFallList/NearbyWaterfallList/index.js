...
const NearbyWaterfallList = exports.NearbyWaterfallList = /*#__PURE__*/(0, _react.memo)(props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_bizComponent.ShowWithData, {
    ...
    ...styles.title,
    ...titleStyle
  }), "getThemeColor(\"cs_common_text_title\")\u7ED3\u679C", JSON.stringify(() => (0, _utils.getThemeColor)("cs_common_text_title"))), /*#__PURE__*/_react.default.createElement(_PerformanceWaterfallList.PerformanceWaterfallList, {
    data: nearbyFeedsist || [],
