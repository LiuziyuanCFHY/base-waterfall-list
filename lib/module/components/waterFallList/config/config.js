...
// 卡片总高度
export const TOTAL_HEIGHT = HEAD_IMG_HEIGHT + PROUDUCT_DISTANCE * 2 + ONE_LINE_TITLE_FONT + MAX_PRICE + PRICE_INFO_MARGIN_TOP + POI_PADDING_TOP + POI_PADDING_BOTTOM + MAX_POI;
// 左瀑布流key
...
export const WEEKLY_ARROW_URL = 'https://s2-11289.kwimgs.com/kos/nlav11289/1/local_life_locallife_small_entrance_arrow_cdn.png';
